...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Verbinden mit dem ThurData-Netzwerk …"),
        ...
        ("install_tip", "Aufgrund der Benutzerkontensteuerung (UAC) kann ThurData-Support in manchen Fällen nicht ordnungsgemäß funktionieren. Um die Benutzerkontensteuerung zu umgehen, klicken Sie bitte auf die Schaltfläche unten und installiereThurData-Support auf dem System."),
        ...
        ("config_acc", "Um Ihren PC aus der Ferne zu steuern, müssen SieThurData-Support Zugriffsrechte erteilen."),
        ("config_screen", "Um aus der Ferne auf Ihren PC zugreifen zu können, müssen SiThurData-Support die Berechtigung \"Bildschirmaufnahme\" erteilen."),
        ...
        ("setup_server_tip", "Ein Mitarbeiter wird sich gleich mit Ihnen verbinden."),
        ...
        ("android_input_permission_tip1", "Damit ein entferntes Gerät Ihr Android-Gerät steuern kann, müssen Sie ThurData-Support erlauben, den Dienst \"Barrierefreiheit\" zu verwenden."),
        ("android_input_permission_tip2", "Bitte gehen Sie zur nächsten Systemeinstellungsseite, suchen Sie \"Installierte Dienste\" und schalten Sie den Dienst \"ThurData-Support Input\" ein."),
        ...
        ("Language", "Sprache"),
        ("Keep ThurData-Support background service", "ThurData-Support im Hintergrund ausführen"),
        ...
        ("Show ThurData-Support", "ThurData-Support anzeigen"),
        ("This PC", "Dieser PC"),
        ("or", "oder"),
        ...
        ("config_input", "Um den entfernten Desktop mit der Tastatur steuern zu können, müssen Sie ThurData-Support die Berechtigung \"Eingabeüberwachung\" erteilen."),
        ("config_microphone", "Um aus der Ferne sprechen zu können, müssen Sie ThurData-Support die Berechtigung \"Audio aufzeichnen\" erteilen."),
        ...
        ("still_click_uac_tip", "Der entfernte Benutzer muss immer noch im UAC-Fenster von ThurData-Support auf \"Ja\" klicken."),
        ...
        ("verify_rustdesk_password_tip", "ThurData-Support-Passwort bestätigen"),
        ...
        ("scam_text1", "Wenn Sie mit jemandem telefonieren, den Sie NICHT KENNEN, dem Sie NICHT VERTRAUEN und der Sie gebeten hat, ThurData-Support zu benutzen und den Dienst zu starten, fahren Sie nicht fort und legen Sie sofort auf."),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "Bitte aktualisieren Sie ThurData-Support Server Pro auf die Version {} oder neuer!"),
        ...
        ("selinux_tip", "SELinux ist auf Ihrem Gerät aktiviert, was dazu führen kann, dass ThurData-Support als kontrollierte Seite nicht richtig läuft."),
        ...
        ("outgoing_only_desk_tip", "Dies ist eine benutzerdefinierte Ausgabe von ThurData-Support.\nSie können eine Verbindung zu anderen Geräten herstellen, aber andere Geräte können keine Verbindung zu Ihrem Gerät herstellen."),
        ("preset_password_warning", "Dies ist eine benutzerdefinierte Ausgabe von ThurData-Support mit einem voreingestellten Passwort. Jeder, der dieses Passwort kennt, kann die volle Kontrolle über Ihr Gerät erlangen. Wenn Sie dies nicht beabsichtigen, deinstallieren Sie diese Software bitte umgehend."),
        ...
        ("allow-only-conn-window-open-tip", "Verbindung nur zulassen, wenn das ThurData-Support-Fenster geöffnet ist"),
        ...
        ("floating_window_tip", "Es hilft dabei, ThurData-Support im Hintergrund auszuführen."),
        ...
        ("About ThurData-Support", "Über ThurData-Support"),
        ...
        ("upgrade_remote_rustdesk_client_to_{}_tip", "Bitte aktualisieren Sie den ThurData-Support-Client auf der Remote-Seite auf Version {} oder neuer!"),
